...
getColors = {type = "function", description = "Get the color values of mutiple pixel points within the region specified", args = "({{x, y}, {x2, y2}}) etc", returns = "(Returns: Table)"},
findColor = {type = "function", description = "Search a region to find the matching specified color.", args = "(color, count, region, debug, rightToLeft, bottomToTop)", returns = "(Returns: Table - Coords of matching points)"},
findColors = {type = "function", description = "Search a region to find the matching specified color on current screen.", args = "(colors, count, region, debug, rightToLeft, bottomToTop)", returns = "(Returns: Table - The coordinate of the first color/s matched in the region)"},
findImage = {type = "function", description = "Search areas matching the specified image. Supports any format of target images. It also provides a debug mode which will produce an image marked the matching areas.", args = "(targetImagePath, count, threshold, region, debug, method)", returns = "(Returns: Table - Centre coord of the matched area )"},
screenshot = {type = "function", description = "Take a screenshot for the whole screen or specified area and save as BMP format at specified file path. The region may be specified as nil", args = "(filepath, region (optional))", returns = "(Returns: None"},
...
currentPath = {type = "function", description = "Get full path of current executing script.", args = "()", returns = "(Returns: Path of executing script)"},
log = {type = "function", description = "Write content to the log file manually", args = "(content [String])", returns = "(Returns: None)"},
...
frontMostAppId = {type = "function", description = "Returns identifier of front most app.", args = "()", returns = "(Returns: String)"},
frontMostAppOrientation = {type = "function", description = "Returns orientation of front most app", args = "()", returns = "(Returns: String)"},
getVersion = {type = "function", description = "Gets the identifier of current front most app as a string. (aka on-screen)", args = "()", returns = "(Returns: String)"},
...
rgbToInt = {type = "function", description = "TTransit values of R,G,B to integer color value.", args = "(r, g, b)", returns = "(Returns: Integer)"}, 
...
dialog = {type = "function", description = "Pop up self-defined dialog box to accept the user input. Please refer to the example for specific usage.", args = "(controls, orientations)", returns = "(Returns: None)"},
...
openURL = {type = "function", description = "Open url, or open other apps’ url scheme. Look at Always-Updated List of iOS App URL Scheme Names and example: Google Maps URL Scheme for iOS", args = "(urlString)", returns = "(Returns: None)"},
isLicensed = {type = "function", description = "Check if the current device is running licensed AutoTouch", args = "()", returns = "(Returns: boolean)"},
toast = {type = "function", description = "Displays an alert that automatically fades away \nAT >= AutoTouch ver.4.2.3", args = "(string)", returns = "(Returns: None)"},
setAutoLaunch = {type = "function", description = "Switch on/off a script as auto launch.", args = "(scriptPath, on)", returns = "(Returns: None)"},
listAutoLaunch = {type = "function", description = "List all auto launch scripts", args = "()", returns = "(Returns: Table)"},
stop = {type = "function", description = "Stop the current script execution.", args = "()", returns = "(Returns: None)"},
ocr = {type = "function", description = "Text recognition from the screen with the Tesseract OCR library. Returns the recognised text", args = "(region, languages, threshold, whitelist, blacklist, timeout, tessdataParentDir, debug)", returns = "(Returns: String)"},
 KEY_TYPE = {
    type = "value",
